...
(function (pContext, $) {
    ...
    var extraCalculations = (function(){
        ...
        function divideSegments(){
            ...
            lines.sort(function(a,b){                           // + 2 + 1 + 2
                var pointsA = a.getAttr("points");              // + 1 + 2 + 1
                var pointsB = b.getAttr("points");              // + 1 + 2 + 1
            ...
            lines.sort(function(a,b){                           // + 2 + 1 + 2
                var intersectsA = checkIntersectionsPath(path,a.getAttr("points")).length;  // 1 + 2 + 2 
                var intersectsB = checkIntersectionsPath(path,b.getAttr("points")).length;  // 1 + 2 + 2
                return -intersectsA + intersectsB;              // + 2 + 2
